...
import { getDomainPolicies, addBlockedDomain, removeDomainPolicy, getPolicySummary } from '../services/api';
...
const NetworkHealth = () => {
  ...
  const fetchData = async () => {
    setLoading(true);
    try {
      const [p, s] = await Promise.all([getDomainPolicies(), getPolicySummary()]);
